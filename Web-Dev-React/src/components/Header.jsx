      ...
      <div className="flex items-center gap-4">
        ...
        {page === 'menu' && (
          <button 
            ...
            className="flex items-center gap-2 border border-white/60 px-3 py-1 mt-3.5 rounded-md font-bold hover:border-[#f07f13] relative transition-all"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" fill="currentColor" viewBox="0 0 16 16">
            ...
            <span className={`${cartCount > 0 ? 'scale-100 opacity-100' : 'scale-0 opacity-0'} absolute -top-2 -right-2.25 bg-[#1f7a3a] text-white w-5 h-5 rounded-full flex items-center justify-center text-[10px] border border-white transition-all`}>
              {cartCount}
            </span>
          </button>
        )}
