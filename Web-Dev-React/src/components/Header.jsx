      ...
      <div className="flex items-center gap-4">
        ...
        {page === 'menu' && (
          ...
          >
            ...
            <span className={`${cartCount > 0 ? 'scale-100 opacity-100' : 'scale-0 opacity-0'} absolute -top-2 -right-2.5 bg-[#1f7a3a] text-white w-5 h-5 rounded-full flex items-center justify-center text-[10px] border border-white transition-all`}>
              {cartCount}
            </span>
          </button>
        )}
